...
def optimize(params, x, y):
    ...
    :param params: list of parameters from hyperopt
...
if __name__ == "__main__":
    ...
    # now we use hyperopt
    param_space = {
        # qniform gives round(uniform(low, high) / q)*q
        ...
        # uniform chooses a values between two values
    ...
    # initalize trails to keep logging information
    trials = Trials()
