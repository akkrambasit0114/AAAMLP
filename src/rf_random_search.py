...
if __name__ == "__main__":
    ...
    # dictionaries
    param_grid={
        "n_estimators": np.arange(100,1500,150),
        "max_depth": np.arange(1,31),
        "criterion": ["gini", "entropy"]
    }

    # initilize random search
    # estimator is the model that we have defined
    # param_grid is the grid/distribution of parameters
    ...
    # if param_distributions has all values as list,
