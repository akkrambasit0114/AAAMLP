...
if __name__ == '__main__':
    ...
    train = pd.read_csv("/Users/insomni_.ak/Documents/Machine Learning/AAAMLP/AAAMLP/input/mobile_train.csv")
...
# do some lamba magic on text columns
traindata = list(
        train.apply(lambda x: '%s %s' %(x['test1'], x['text2']), axis=1)
)
testdata = list(
