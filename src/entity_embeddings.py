...
def create_model(data, catcols):
    ...
    # init list of outputs for embeddinds
    outputs = []
    ...
    for c in catcols:
        ...
        # min size of half of the number of unique values
    ...
    # this is the architechture I like to use
    ...
    # compile the model
    # we can use adam and binary cross entropy.
...
def run(fold):
    ...
    model = create_model(df, features) # <--- to be written
    ...
    # convert target columns to categoreis 
    # this is just binarization
    ytrain_cat = utils.to_cateogorical(ytrain)
